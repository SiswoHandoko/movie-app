...
@Component({
  selector: 'app-indonesia-movie',
  templateUrl: './indonesia-movie.component.html',
  styleUrls: ['./indonesia-movie.component.css']
})
export class IndonesiaMovieComponent implements OnInit {
  ...
  getPage(page: number) {
    ...
    this.appService.getIndonesiaMovie(page).subscribe(res => {
      this.loading = true;
